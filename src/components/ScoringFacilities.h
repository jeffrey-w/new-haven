...
class GatherFacility : public Observable {
  ...
  public:
    ...
    void reset();
    // Decrements this GatherFacility's count of the specified type by the specified cost. Throws an exception if the
    // specified type is out of this GatherFacility's bounds, or if the resources available are insufficiet to cover
    // the specified cost.
    void use(int, int);
    // Increments this GatherFacility's count of the specified type by the specified amount. Throws an exception if the
    // specified type is out of this GatherFacility's bounds, or if the specified amount is negative.
    void save(int, int);
